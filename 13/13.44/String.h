...
// member functions
inline String::String(const CharT *s, const Allocator &alloc) : allocator(alloc) {
...
inline String::String(std::initializer_list<CharT> ilist, const Allocator &alloc) : allocator(alloc) {
    // works because iterators and pointers are same thing at the moment
