...
inline StrBlob::reference StrBlob::front() { return iterator(*this).deref(); }

inline StrBlob::reference StrBlob::back() { return iterator(*this, this->size() - 1).deref(); }
...
// functions - data access
inline StrBlob::const_reference StrBlob::front() const { return const_iterator(*this).deref(); }

inline StrBlob::const_reference StrBlob::back() const { return const_iterator(*this, this->size() - 1).deref(); }
